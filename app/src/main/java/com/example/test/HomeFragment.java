...
import com.example.test.MangaAdapter;
import com.example.test.Manga;
import com.example.test.MangaParser;
import com.example.test.ParserMangaDex;
import com.example.test.Store;
...
public class HomeFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    private class FetchMangaTask extends AsyncTask<Void, Void, List<Manga>> {
        ...
        protected List<Manga> doInBackground(Void... voids) {
            if (parser == null) {
                parser = ParserMangaDex.getInstance("vi");
            }
        ...
        protected void onPostExecute(List<Manga> mangaList) {
            ...
            if (mangaList == null) {
                Snackbar.make(view, "Lỗi", Snackbar.LENGTH_SHORT).show();
                return;
            }
            if (pageNum == 0) {
